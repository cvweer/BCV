...
The variance of the sample is significantly higher than in the origninal data set. This because 
*step c*
...
the mean and the standard deviation can be found in the console. The histogram is right skewed
